...
# ─── Price map (title → price in ₸) ─────────────────────────────────────────
# Rational prices based on product category and market value.
PRICE_MAP = {
    # Диваны
    "ДИВАН 1": 285000, "ДИВАН 2": 320000, "ДИВАН 3": 295000, "ДИВАН 4": 340000, "ДИВАН 5": 310000,
    # Кресла
    "КРЕСЛО 1": 95000, "КРЕСЛО 2": 110000, "КРЕСЛО 3": 89000, "КРЕСЛО 4": 125000,
    "КРЕСЛО 5": 135000, "КРЕСЛО 6": 78000, "КРЕСЛО 7": 105000, "КРЕСЛО 8": 115000,
    # Пуфы
    "ПУФ 1": 35000, "ПУФ 2": 38000, "ПУФ 3": 32000, "ПУФ 4": 36000, "ПУФ 5": 28000,
    "ПУФ 6": 40000, "ПУФ 7": 37000, "ПУФ 8": 30000,
    # Стеллажи
    "СТЕЛЛАЖ 1": 145000, "СТЕЛЛАЖ 2": 165000, "СТЕЛЛАЖ 3": 155000,
    # Тумбы
    "ТУМБА 1": 65000, "ТУМБА 2": 72000,
    # Стулья
    "СТУЛ 1": 45000, "СТУЛ 2": 52000,
    # Шкафы
    "ШКАФ 1": 185000, "ШКАФ 2": 210000,
    # Столы
    "СТОЛ 1": 95000, "СТОЛ 2": 120000,
    # Кухня
    "КУХНЯ 1": 350000, "КУХНЯ 2": 420000,
    # Школьные стулья
    "ШКОЛЬНЫЙ СТУЛ 1": 18000, "ШКОЛЬНЫЙ СТУЛ 2": 22000, "ШКОЛЬНЫЙ СТУЛ 3": 25000, "ШКОЛЬНЫЙ СТУЛ 4": 20000,
    # Мягкие стулья
    "МЯГКИЙ СТУЛ 1": 48000, "МЯГКИЙ СТУЛ 2": 52000, "МЯГКИЙ СТУЛ 3": 55000,
    # Барные стулья
    "БАРНЫЙ СТУЛ 1": 62000, "БАРНЫЙ СТУЛ 2": 68000,
    # Встроенные шкафы
    "ВСТРОЕННЫЙ ШКАФ 1": 220000, "ВСТРОЕННЫЙ ШКАФ 2": 245000, "ВСТРОЕННЫЙ ШКАФ 3": 235000,
    # Стандартные шкафы
    "СТАНДАРТНЫЙ ШКАФ 1": 195000,
    # Парты
    "ПАРТА 1": 75000, "ПАРТА 2": 85000, "ПАРТА 3": 92000,
    "ПАРТА 4": 78000, "ПАРТА 5": 88000, "ПАРТА 6": 95000,
    # Ресепшен
    "РЕСЕПШЕН 1": 180000, "РЕСЕПШЕН 2": 210000, "РЕСЕПШЕН 3": 250000,
    # Спец столы для преподавателя
    "СПЕЦ СТОЛ ДЛЯ ПРЕПОДАВАТЕЛЯ 1": 125000, "СПЕЦ СТОЛ ДЛЯ ПРЕПОДАВАТЕЛЯ 2": 140000,
    # Гос. символика
    "ГОСУДАРСТВЕННАЯ СИМВОЛИКА 1": 55000, "ГОСУДАРСТВЕННАЯ СИМВОЛИКА 2": 65000, "ГОСУДАРСТВЕННАЯ СИМВОЛИКА 3": 75000,
    # 3D панели
    "РЕЕЧНЫЙ": 12000, "РЕЛЬЕФНЫЕ": 15000, "ЛИНЕЙНЫЕ": 11000,
    "ВОЛНИСТЫЙ": 14000, "УЗОРЧАТЫЕ": 16000, "ФИГУРНЫЕ": 18000,
    # Освещение
    "START (светильник 1)": 28000, "LEZARD (светильник 2)": 32000,
    "ВСТРАИВАЕМЫЙ СВЕТИЛЬНИК ЭРА": 24000, "TEKLED LED SLIM ROUND": 18000,
    "ELEKTROSTANDARD": 22000, "LED ЛЕНТЫ": 8500, "LEDS C4": 85000,
    "LED PENDELLEUCHTE OVAL": 65000, "VOLTA LIGHTSTAR": 42000,
    "LEZARD (светильник 3)": 32000, "ARKOSLIGHT FIFTY HO SUSPENDED": 95000,
    "START (светильник 4)": 28000, "RULLO LIGHTSTAR": 38000,
    "AURA WN02W H-GU10": 15000, "DK LED WALL SPOTLIGHT": 45000,
    "START (светильник 5)": 25000,
    # Перегородки
    "СТЕКЛО": 120000, "РЕЙКИ": 95000, "МЕТАЛЛ": 145000,
    # Шторы
    "РУЛОННЫЕ": 28000, "ЖАЛЮЗИ": 35000, "ТКАНЕВЫЕ": 45000,
    # Растения
    "ДЕРЕВО": 55000, "КОМАНДНЫЕ РАСТЕНИЯ": 38000, "РАСТИТЕЛЬНОСТЬ НА СТЕНЕ": 65000,
    # Доски
    "МАРКЕРНАЯ ДОСКА": 25000, "ГРИФЕЛЬНАЯ ДОСКА": 32000, "СТЕКЛЯННАЯ ДОСКА": 45000,
    # Станки
    "UNIMAT ML 160200": 450000, "UNIMAT 1 BASIC 4B1": 380000, "УЧЕБНЫЙ СТАНОК": 285000,
    # Компьютеры
    "AVTECH PRO (ПК)": 280000, "AVTECH PRO (Ноутбук)": 320000,
    # Интерактивные панели
    "Интерактивная панель ROQED SCIENCE": 850000,
    # Инфокиоски
    "Инфокиоск STEM": 650000,
    # Бытовая техника
    "Бытовая техника STEM": 180000,
    # 3D принтеры
    "3D принтер FLASHFORGE 5M": 350000,
    # Лаборатория
    "ЦИФРОВАЯ ЛАБОРАТОРИЯ LABDISC": 450000,
    # ULAB
    "НАБОР ULABS (Лабораторный комплект)": 380000,
    # Старые/тестовые товары
    "Диван крутость": 295000,
    "Мемориальная доска с гербом РК": 45000,
    "Стенд с Конституцией Республики Казахстан": 55000,
    "3D панель Геометрия белая": 14000,
    "Линейный подвесной светильник 120 см": 18000,
    "Реечная декоративная перегородка": 95000,
    "Рулонные шторы Blackout": 28000,
    "Искусственное растение Банан 180 см": 45000,
    "Магнитно-маркерная доска 180×120 см": 32000,
}
...
skipped_prods = 0
for p in PRODUCTS:
    # Apply price from PRICE_MAP if not already set
    if "price" not in p and p["title"] in PRICE_MAP:
        p["price"] = PRICE_MAP[p["title"]]
